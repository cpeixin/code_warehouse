...
//      .keyBy((_: UserLogData).province)
//      .timeWindow(Time.seconds(5))
//      .sum("channel")
//      .print("key_by")


    val process_stream: AllWindowedStream[UserLogData, TimeWindow] = original_stream
      .map(match_data(_: String))
